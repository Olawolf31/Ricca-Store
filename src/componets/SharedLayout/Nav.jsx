...
export const CartIcon = () => {
  return (
      ...
      <div className="relative">
        <CiShoppingCart className="w-8 h-8 relative text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" />
      ...
      <div className="container px-6 py-6 mx-auto md:flex md:justify-between md:items-center">
        <div className="flex items-center justify-between">
          ...
          <div className="flex lg:hidden md:hidden">
            <button
              type="button"
              className={`pb-6 text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400`}
